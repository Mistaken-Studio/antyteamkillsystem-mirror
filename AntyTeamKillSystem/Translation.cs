...
namespace Mistaken.AntyTeamKillSystem
{
    ...
    {
        /// <summary>
        /// Gets or sets patern how to display <see cref="TeamKill"/>.
        /// </summary>
        [Description("Defines how TeamKill info is displayed in client console")]
        public string[] TeamKillInfo { get; set; } = new string[]
        {
            "Attacker: {Attacker}",
        ...
        /// <summary>
        /// Gets or sets patern how to display <see cref="TeamAttack"/>.
        /// </summary>
        [Description("Defines how TeamAttack info is displayed in client console")]
        public string[] TeamAttackInfo { get; set; } = new string[]
        {
            "Attacker: {Attacker}",
            "Attacker Team: {AttackerTeam}",
            "Victim: {Victim}",
